...
- (void)updateProgress {
  ...
  //专辑图片旋转
  self.picture.transform =
      CGAffineTransformRotate(self.picture.transform, M_PI / 1440);
  ...
  self.timerProgressBar.progress =
      self.player.currentPlaybackTime / [self.playingSong.length intValue];
}
